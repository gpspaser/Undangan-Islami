...
<style>
/* PAKSA HILANGKAN SEMUA ELEMENT BLOGGER */
.navbar,.Header1,.header-outer,.tabs-outer,.footer-outer,.post-title,.blog-pager,.status-msg-wrap,.widget-content,.Attribution,.blog-posts{display:none!important;height:0!important;overflow:hidden!important;margin:0!important;padding:0!important}
body{padding:0!important;margin:0!important}
.content-outer,.content-fauxcolumn-outer,.main-outer,.footer-outer,.header-outer{padding:0!important;margin:0!important;width:100%!important}
.main-inner,.content-inner,.post-body{padding:0!important;margin:0!important}
html body .region-inner{padding:0!important}
...
html,body{height:100%;overflow-x:hidden;background:var(--cream)!important}
...
.menu-item::before{content:'';position:absolute;top:0;left:0;right:0;height:4px;background:linear-gradient(90deg,var(--gold-dark),var(--gold))}
...
function kirimUndangan(jenis){
  ...
  if(jenis==='maulid'){
    ...
    pesan += `dalam acara *Peringatan Maulid Nabi Muhammad SAW*%0A`;
